            ...
            <div key={r.id} className="card card-side bg-base-100 shadow-xl">
              ...
              <div className="card-body tracking-widest">
                ...
                <div className="">
                  ...
                  <p className="text-lg text-gray-500"><span className="font-semibold text-black">Cooking Method: </span>{cooking_method}</p> <br />
                ...
                <div className="mt-auto text-center">
                  <button className="btn normal-case">Favourite</button>
                </div>
              </div>
            </div>
          ))}
